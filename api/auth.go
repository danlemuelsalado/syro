...
func Login(email string, password string, env string) (companyId string, expiresAt string, memberId string, sessionToken string, err error) {
	client := resty.New()
...
func ValidateAccessTokenAndProjectId(accessToken string, projectId string, env string) (companyId string, verifiedAccessToken string, verifiedProjectId string, err error) {
	client := resty.New()
...
func ValidateSessionToken(sessionToken string, env string) (isSessionTokenValid bool, err error) {
	client := resty.New()
